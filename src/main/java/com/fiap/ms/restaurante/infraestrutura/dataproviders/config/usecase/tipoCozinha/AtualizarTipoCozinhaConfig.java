...
@Configuration
public class AtualizarTipoCozinhaConfig {

    @Bean
    public AtualizarTipoCozinhaUseCaseImpl atualizarTipoCozinhaUseCase(TipoCozinha tipoCozinha,
                                                                       TipoCozinhaDomainService tipoCozinhaDomainService) {
        return new AtualizarTipoCozinhaUseCaseImpl(tipoCozinha, tipoCozinhaDomainService);
    }
}
