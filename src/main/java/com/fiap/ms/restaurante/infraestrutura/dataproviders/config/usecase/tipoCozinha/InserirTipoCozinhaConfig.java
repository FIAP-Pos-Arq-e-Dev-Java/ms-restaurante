...
@Configuration
public class InserirTipoCozinhaConfig {

    @Bean
    public InserirTipoCozinhaUseCaseImpl inserirTipoCozinhaUseCase(TipoCozinha tipoCozinha,
                                                                   TipoCozinhaDomainService tipoCozinhaDomainService) {
        return new InserirTipoCozinhaUseCaseImpl(tipoCozinha, tipoCozinhaDomainService);
    }
}
